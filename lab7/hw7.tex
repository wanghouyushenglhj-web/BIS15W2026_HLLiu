...
\NormalTok{elephant }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{mean\_age\_f=}\FunctionTok{mean}\NormalTok{(estimated\_age\_years,}\AttributeTok{na.rm=}\NormalTok{T),}
            ...
            \AttributeTok{sd\_age\_f=}\FunctionTok{sd}\NormalTok{(estimated\_age\_years,}\AttributeTok{na.rm=}\NormalTok{T))}\CommentTok{\#mean,median,sd for age of females during year of 2005{-}13}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{elephant }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{mean\_age\_f=}\FunctionTok{mean}\NormalTok{(estimated\_age\_years,}\AttributeTok{na.rm=}\NormalTok{T),}
            \AttributeTok{median\_age\_f=}\FunctionTok{median}\NormalTok{(estimated\_age\_years,}\AttributeTok{na.rm=}\NormalTok{T),}
            \AttributeTok{sd\_age\_f=}\FunctionTok{sd}\NormalTok{(estimated\_age\_years,}\AttributeTok{na.rm=}\NormalTok{T))}\CommentTok{\#mean,median,sd for age of females during year of 1966{-}68}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{elephant }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{mean\_age\_m=}\FunctionTok{mean}\NormalTok{(estimated\_age\_years,}\AttributeTok{na.rm=}\NormalTok{T),}
            ...
            \AttributeTok{sd\_age\_m=}\FunctionTok{sd}\NormalTok{(estimated\_age\_years,}\AttributeTok{na.rm=}\NormalTok{T))}\CommentTok{\#mean,median,sd for age of males during year of 1966{-}68}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{elephant }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{mean\_age\_m=}\FunctionTok{mean}\NormalTok{(estimated\_age\_years,}\AttributeTok{na.rm=}\NormalTok{T),}
            \AttributeTok{median\_age\_m=}\FunctionTok{median}\NormalTok{(estimated\_age\_years,}\AttributeTok{na.rm=}\NormalTok{T),}
            \AttributeTok{sd\_age\_m=}\FunctionTok{sd}\NormalTok{(estimated\_age\_years,}\AttributeTok{na.rm=}\NormalTok{T))}\CommentTok{\#mean,median,sd for age of males during year of 2005{-}13}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{elephant }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{shoulder\_height\_in\_cm,}\AttributeTok{y=}\NormalTok{tusk\_length\_in\_cm))}\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{mapping =}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color=}\NormalTok{tusk\_length\_in\_cm))}\SpecialCharTok{+}
  \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{method =}\NormalTok{ lm)}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title=}\StringTok{"Shoulder height vs Tusk length"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{hw7_files/figure-latex/unnamed-chunk-18-1.pdf}}
...
\NormalTok{elephant }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{mapping =}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color=}\NormalTok{years\_of\_sample\_collection))}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title=}\StringTok{"Tusk length before(1966{-}68) and after(2005{-}13) the poaching"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{hw7_files/figure-latex/unnamed-chunk-20-1.pdf}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mature\_f }\OtherTok{\textless{}{-}}\NormalTok{ elephant }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(sex}\SpecialCharTok{==}\StringTok{"f"}\NormalTok{,estimated\_age\_years}\SpecialCharTok{\textgreater{}}\DecValTok{12}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mature\_m}\OtherTok{\textless{}{-}}\NormalTok{ elephant }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(sex}\SpecialCharTok{==}\StringTok{"m"}\NormalTok{,estimated\_age\_years}\SpecialCharTok{\textgreater{}}\DecValTok{25}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mature }\OtherTok{\textless{}{-}}\NormalTok{ elephant }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{((sex}\SpecialCharTok{==}\StringTok{"f"}\SpecialCharTok{\&}\NormalTok{estimated\_age\_years}\SpecialCharTok{\textgreater{}}\DecValTok{12}\NormalTok{)}\SpecialCharTok{|}\NormalTok{(sex}\SpecialCharTok{==}\StringTok{"m"}\SpecialCharTok{\&}\NormalTok{estimated\_age\_years}\SpecialCharTok{\textgreater{}}\DecValTok{25}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mature }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{years\_of\_sample\_collection,}\AttributeTok{y=}\NormalTok{tusk\_length\_in\_cm))}\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{mapping =}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color=}\NormalTok{years\_of\_sample\_collection))}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title=}\StringTok{"Mature elephant Tusk length before(1966{-}68) and after(2005{-}13) the poaching"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{hw7_files/figure-latex/unnamed-chunk-27-1.pdf}}
