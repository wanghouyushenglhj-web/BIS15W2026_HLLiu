...
homerange %>%
  ...
  arrange(desc(mean.hra.m2)) %>% #from this step i got top 10 and i found the homerange of number 11 and then filter to show only tope 10
  filter(mean.hra.m2>42065883)
```
