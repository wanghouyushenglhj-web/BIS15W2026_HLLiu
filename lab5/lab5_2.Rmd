...
```{r}
filter(penguins,body_mass_g%in%c(5250,5500,5300,5350,5400,5450))
```
...
```{r}
filter(penguins,species=="Chinstrap"|body_mass_g>4500)# it means or
```
...
fish %>% 
  ...
  filter(lakeid==c("AL","AR")&between(radii_length_mm,2,4)) %>% 
